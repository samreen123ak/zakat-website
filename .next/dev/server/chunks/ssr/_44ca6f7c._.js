...
function StaffLoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/auth/login`, {
                method: "POST",
                headers: {
